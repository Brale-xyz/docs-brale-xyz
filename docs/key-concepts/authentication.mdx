...
![Brale Dashboard Create API Credentials Screenshot](./img/create-api-credentials.png)
...
![Brale Dashboard Created API Credentials Screenshot](./img/authenticated-requests.png)
