...
<Intro heading="Idempotency" subheading="Guarantee that each POST request executes exactly once." />
...
| Retry with _same_ body                   | 201 Created              | _Same_ JSON as first call                                                     |
