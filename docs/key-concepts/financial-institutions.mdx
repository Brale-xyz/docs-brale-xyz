...
<HTTPMethod
  method="POST"
  endpoint="https://api.brale.xyz/accounts/account_id/financial_institution/plaid/link_token"
/>

```json title="Request"
{
  "user_id": "user_123456789", // Required
...
<HTTPMethod
  method="POST"
  endpoint="https://api.brale.xyz/accounts/account_id/financial_institution/register_account"
/>
...
<HTTPMethod
  method="GET"
  endpoint="https://api.brale.xyz/accounts/account_id/financial_institutions/:id"
/>
