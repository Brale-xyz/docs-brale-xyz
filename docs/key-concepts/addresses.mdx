...
<HTTPMethod
  method="GET"
  endpoint="https://api.brale.xyz/accounts/{account_id}/addresses?type=external&transfer_type=solana&transfer_type=base"
/>
...
<HTTPMethod
  method="GET"
  endpoint="https://api.brale.xyz/accounts/{account_id}/addresses?address=0xEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"
/>
...
<HTTPMethod
  method="GET"
  endpoint="https://api.brale.xyz/accounts/{account_id}/addresses?type=internal&transfer_type=ethereum"
/>
