...
- Off-chain rails: `wire`, `ach_credit`, `same_day_ach_credit`, `ach_debit`, `same_day_ach_debit`, `rtp`.
...
<HTTPMethod method="POST" endpoint="/accounts/{account_id}/addresses/external" />
...
Instead of creating a new Address, you can **add** new `transfer_types` to an existing Address:

Onchain Address Example
<HTTPMethod method="PATCH" endpoint="/accounts/{account_id}/addresses/{{address_id}}" />
...
Offchain Address Example
<HTTPMethod method="PATCH" endpoint="/accounts/{account_id}/addresses/{{address_id}}" />

```json title="Request"
{
  "transfer_types": ["same_day_ach_credit", "ach_credit"]
}
```
...
- This endpoint only updates transfer capabilities; it does **not** change other Address fields like `owner`, `wallet_address`, `account_number`, or `routing_number`.
...
<HTTPMethod method="POST" endpoint="https://api.brale.xyz/accounts/{account_id}/plaid/link_token" />
...
<HTTPMethod
  method="POST"
  endpoint="https://api.brale.xyz/accounts/{account_id}/plaid/register-account"
/>
...
<HTTPMethod method="GET" endpoint="https://api.brale.xyz/accounts/account_id/address/{id}" />
...
<HTTPMethod
  method="GET"
  endpoint="https://api.brale.xyz/accounts/{account_id}/addresses/{address_id}"
/>
...
<HTTPMethod
  method="POST"
  endpoint="https://api.brale.xyz/accounts/{account_id}/addresses/{address_id}/update-link-token"
/>
...
<HTTPMethod method="GET" endpoint="/accounts/{account_id}/addresses" />
...
<HTTPMethod
  method="GET"
  endpoint="/accounts/{account_id}/addresses/address_id/balance?transfer_type=chain&value_type=token"
/>
...
<HTTPMethod
  method="GET"
  endpoint="/accounts/{account_id}/addresses?type=external&transfer_type=solana&transfer_type=base"
/>
...
<HTTPMethod
  method="GET"
  endpoint="/accounts/{account_id}/addresses?address=0xEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE"
/>
...
<HTTPMethod
  method="GET"
  endpoint="/accounts/{account_id}/addresses?type=internal&transfer_type=ethereum"
/>
