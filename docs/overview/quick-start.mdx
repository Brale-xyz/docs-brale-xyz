...
<Intro
  heading="Quick Start - Your First Stablecoin Transfer"
  subheading="Get authenticated, grab your IDs, and create your first stablecoin transfer in less than five minutes."
/>
