...
**POST** `https://api.brale.xyz/accounts/your_account_id/transfer`
...
Now that you've completed your first transfer, follow [Guides](/docs/category/guides) to get a deeper understanding of how to build with Brale.
