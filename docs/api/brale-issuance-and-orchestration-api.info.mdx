...
**What's new in 2.2.0** - Unified **Addresses** model for on-chain and off-chain endpoints
...
- Added off-chain rails: `ach-credit`, `same-day-ach-credit`, `ach-debit`, `same-day-ach-debit`, `rtp-credit` - Plaid endpoints moved to `/accounts/{account_id}/plaid/*` - `Financial Institutions` marked **deprecated** (migration path to **Addresses**)
