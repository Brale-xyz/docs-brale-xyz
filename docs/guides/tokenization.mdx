...
sidebar_label: 'Tokenization Overview'
---
...
<HTTPMethod method="POST" endpoint="https://api.brale.xyz/accounts/account_id/tokens/mints" />
...
<HTTPMethod method="POST" endpoint="https://api.brale.xyz/accounts/account_id/tokens/burns" />
...
[`POST /tokens/mints`](/tokens/mints) - Mint tokens

[`POST /tokens/burns`](/tokens/burns) - Burn tokens

[`POST /tokens/transfers`](/tokens/transfers) - Transfer tokens

[`GET /tokens/tranactions`](/tokens/transactions) - Fetch all mints, burns, and transfers transactions
